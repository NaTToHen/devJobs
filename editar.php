<?php 
   if(!empty($_GET['id']))
   {
      ...
      $sqlcode = "SELECT * FROM usuario WHERE id_usuario=$id";
...
<body>
   ...
   <div id="direita">
      ...
      <div class="form">
         <?php
         echo "<form action='lib/saveEditar.php' method='POST'>
            <h1>Editar Usuario</h1>
            <input name='nome' type='text' placeholder='nome' value='$nome' required>
            <input name='email' class='email' type='email' placeholder='' value='$email' required>
            <input name='telefone' type='text' placeholder='telefone' value='$telefone' required>
